...
pub fn enable_uart(uart: &max32660_pac::UART0, enable: bool) {
    unsafe {
...
pub fn set_baud(uart: &max32660_pac::UART0, peripheral_clk: u32, baud: u32) -> Result<(), UartError> {
...
pub fn enable_interrupts(uart: &max32660_pac::UART0, ints: &[Interrupts]) {
...
pub fn set_flow_control(uart: &max32660_pac::UART0, enable: bool, polarity: FlowControlPolarity) {
    unsafe {
        uart.ctrl.modify(|r, w| {
...
pub fn set_char_size(uart: &max32660_pac::UART0, s: CharSize) {
    unsafe {
        uart.ctrl.modify(|r, w| {
...
pub fn set_parity(uart: &max32660_pac::UART0, enable: bool, parity: Parity, level: ParityLevel) {
    todo!("Configure parity")
}

pub fn set_stop_bit(uart: &max32660_pac::UART0, stop: StopBits) {
...
pub fn flush_rx_fifo(uart: &max32660_pac::UART0) {
    unsafe {
        uart.ctrl.modify(|r, w| {
...
pub fn flush_tx_fifo(uart: &max32660_pac::UART0) {
    unsafe {
        uart.ctrl.modify(|r, w| {
...
pub fn set_rx_fifo_threshold(uart: &max32660_pac::UART0, threshold: FifoThreshold) {
    unsafe {
...
pub fn set_tx_fifo_threshold(uart: &max32660_pac::UART0, threshold: FifoThreshold) {
    unsafe {
        uart.thresh_ctrl.modify(|r, w| {
...
pub fn set_rts_fifo_threshold(uart: &max32660_pac::UART0, threshold: FifoThreshold) {
    unsafe {
        uart.thresh_ctrl.modify(|r, w| {
...
pub fn clear_interrupt(uart: &max32660_pac::UART0, ints: &[Interrupts]) {
